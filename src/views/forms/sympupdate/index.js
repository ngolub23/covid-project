...
import { CCard, CButton, CCardBody, CCardHeader, CCol, CFormCheck, CFormSwitch, CRow } from '@coreui/react'
    ...
    <CRow>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <CFormCheck id="flexCheckDefault" label="Coughing" />
            <CFormCheck id="flexCheckDefault" label="Runny nose" />
            <CFormCheck id="flexCheckDefault" label="Loss of taste or smell" />
            <CFormCheck id="flexCheckDefault" label="Headaches" />
            <CFormCheck id="flexCheckDefault" label="Nausea" />
            <CFormCheck id="flexCheckDefault" label="Fatigue" />
            <CFormCheck id="flexCheckDefault" label="Sore throat" />
